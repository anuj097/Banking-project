package my.project.mailservice.security;
...
public class MailServiceSecurity {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http
				...
				.authorizeHttpRequests(authz -> authz
						.requestMatchers("//Mail-service/send").permitAll() // Public endpoints - no need of authorization
						.anyRequest().authenticated() // Any other request requires authentication
				)

				// Enable HTTP Basic authentication
				.httpBasic(httpBasic -> httpBasic.realmName("This is a Mail Service Application")
