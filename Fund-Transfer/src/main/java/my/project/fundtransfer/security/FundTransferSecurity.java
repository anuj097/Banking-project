package my.project.fundtransfer.security;
...
public class FundTransferSecurity {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http
				...
				.authorizeHttpRequests(authz -> authz
						.requestMatchers("/fund-transfer/tansfer").permitAll() // Public endpoints - no need of authorization
						.requestMatchers("/actuator/**").permitAll()
						//.hasRole("HAS_ACTUATOR_VIEWER")
						.anyRequest().authenticated() // Any other request requires authentication
				)

				// Enable HTTP Basic authentication
				.httpBasic(httpBasic -> httpBasic.realmName("This is a Fund Transfer Application")
